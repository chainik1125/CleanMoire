...
**Current pipeline**
1. First generate or find a template matrix object (matrix_templates.py file).
2. Load a function that assigns the correct coefficients, as a function of k, to each matrix template.
