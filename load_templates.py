...
def find_template_dirs(parent_dir,particle_no,shells_used,center):
    dir_path_kx=parent_dir+f'/{particle_no}particles_{shells_used}shells_center{center}_matrices/kx'
    filelist_kx=[dir_path_kx+'/'+f for f in os.listdir(dir_path_kx) if os.path.isfile(os.path.join(dir_path_kx, f))]
    dir_path_ky=parent_dir+f'/{particle_no}particles_{shells_used}shells_center{center}_matrices/ky'
    filelist_ky=[dir_path_ky+'/'+f for f in os.listdir(dir_path_ky) if os.path.isfile(os.path.join(dir_path_ky, f))]
    dir_path_kind=parent_dir+f'/{particle_no}particles_{shells_used}shells_center{center}_matrices/qadjust'
    filelist_kind=[dir_path_kind+'/'+f for f in os.listdir(dir_path_kind) if os.path.isfile(os.path.join(dir_path_kind, f))]
    dir_path_tun=parent_dir+f'/{particle_no}particles_{shells_used}shells_center{center}_matrices/tun'
    filelist_tun=[dir_path_tun+'/'+f for f in os.listdir(dir_path_tun) if os.path.isfile(os.path.join(dir_path_tun, f))]
    HK_list=[parent_dir+f'/{particle_no}particles_{shells_used}shells_center{center}_matrices/HK_rot/HK_rot_None.dill',
                parent_dir+f'/{particle_no}particles_{shells_used}shells_center{center}_matrices/HK_orb/HK_orb_None.dill',
                parent_dir+f'/{particle_no}particles_{shells_used}shells_center{center}_matrices/HK_N_taux/HK_N_taux_None.dill']
