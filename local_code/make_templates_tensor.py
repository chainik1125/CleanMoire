...
if __name__ == "__main__":
    ...
    # term_list_dic_term=term_list_dic
    # term_number=0

    # construct_templates(dir_path=dir_path,term_list_dic=term_list_dic_term,term_number=term_number,basis_state_list=shell_basis_dicts,basis_tensor=test_tensor_states,make_all=True,make_int=True)
    # exit()
    ...
    #     saved_mat_path=f"/Users/dmitrymanning-coe/Documents/Research/Barry Bradlyn/Moire/CleanMoire/large_files/tensor/test/{particles1}particles_{shells_used}shells_center{center}_matrices/{dir0}/{dir0}_{i}.dill"
    ...
    #     print(f'herro')
    #     print(vars(test_matrix_tensor))
    #     print(f'herro')
    #     test_matrix_tensor=test_matrix_tensor.form_matrix()
    #     test_matrix_tensor=test_matrix_tensor.todense()
    #     print(test_matrix_tensor)
    ...
    start=time.time()
    HkA=load_templates.gen_Hk2_tensor(kx=A[0],ky=A[1],particles_used=particle_no)
