...
if __name__ == "__main__":
    ...
    construct_templates(dir_path=cluster_dir_path,term_list_dic=term_list_dic,term_number=0,basis_state_list=shell_basis_dicts,basis_tensor=test_tensor_states,make_all=True,make_int=True)
    exit()
