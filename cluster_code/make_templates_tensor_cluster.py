...
if __name__ == "__main__":
    ...
    cluster_dir_path=f"/projects/illinois/eng/physics/bbradlyn/dmitry2/Moire/large_files/matrix_templates/tensor/{particles}particles_{shells}shells_center{center}_matrices/ham_terms"
    ...
    construct_templates(dir_path=cluster_dir_path,term_list_dic=term_list_dic_term,term_number=term_number,basis_state_list=shell_basis_dicts,basis_tensor=test_tensor_states,make_all=False,make_int=True)
    exit()
